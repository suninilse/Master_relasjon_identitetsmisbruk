...
#deskriptiv statistikk presentert i del 3.5.7
...
#deskriptiv statistikk presentert i del 4.1 i oppgaven
...
#deskriptiv statistikk presentert i delkapittel 4.4 i oppgaven

sivile_saker %>% dplyr::select (hvorfor_passord) %>% tbl_summary()

#oppgivelse av passord i tilit, til nærstående-----
#deskriptiv statistikk presentert i delkapitel 4.4 i oppgaven
...
#deskriptiv statistikk presentert i delkapittel 4.5 i oppgaven
#dette er en krysstabell, jeg regnet ut prosent manuelt
...
#deskriptiv statistikk presentert i delkapittel 5.3 i oppgaven
...
#deskriptiv statistikk presentert i dekapittel 5.5 i oppgaven
...
#deskriptiv statistikk presentert i delkapittel 5.6 i oppgaven
...
#presentert i Tabell 2 i oppgaven, del 4.1
...
#tabell presentert i Tabell 1, i delkapittel 3.5.7 i oppgaven
...
#tabell presentert i tabell 2, del 4.1 i oppgaven
...
#utvalg til den kvalitative analysen-------
#sivile saker utvalg-----

sivile_saker %>% dplyr::select (nærstående, referanse, utfall_finans_endret) %>% filter(nærstående == 1) %>% tbl_summary(by=utfall_finans_endret)

#straffesaksutvalg------
#eskluderer frifinnelser

straffe_saker %>% dplyr::select (nærstående, referanse, utfall_strl) %>% filter (utfall_strl != 4) %>% filter(nærstående == 1) %>% tbl_summary()
